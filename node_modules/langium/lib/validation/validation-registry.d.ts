...
import { AstNode, AstTypeList, Properties } from '../syntax-tree';
...
export declare class ValidationRegistry {
    ...
    register<T extends AstTypeList<T>>(checksRecord: ValidationChecks<T>, thisObj?: ThisParameterType<unknown>): void;
