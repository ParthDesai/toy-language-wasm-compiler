...
import { Action, Assignment, Interface, ParserRule, Type, TypeAttribute } from '../generated/ast';
export declare class LangiumGrammarReferences extends DefaultReferences {
    ...
    protected findLocalReferences(targetNode: AstNode, includeDeclaration?: boolean): Stream<ReferenceDescription>;
    protected findGlobalReferences(targetNode: AstNode, includeDeclaration?: boolean): Stream<ReferenceDescription>;
